...
main() {
  ...
  if [ "$OS" = "macOS" ]; then
    ...
    make_link "$DOT_DIR/vscode/settings.json" "$HOME/Library/Application Support/Code/User/settings.json"
  else
    make_link "$DOT_DIR/vscode/keybindings.json" "$HOME/.config/Code/User/keybindings.json"
